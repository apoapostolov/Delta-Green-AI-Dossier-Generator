...
const BASE_KITS: EquipmentKit[] = [
    {
        name: 'FEDERAL AGENT',
        description: 'Standard issue gear for a federal law enforcement agent, including a sidearm, body armor, and basic investigation tools.',
        items: [
    ...
    {
        name: 'SWAT TEAM',
        description: 'Heavy tactical equipment for high-risk entries, including an assault rifle, heavy body armor, and breaching tools.',
        items: [
            'Agency Badge and Identification Card',
    ...
    },
    {
        ...
        description: 'Military special operations loadout for direct action, with a suppressed carbine, advanced night vision, and explosives.',
        items: [
            'Dog Tags',
    ...
    {
        name: 'POLICE OFFICER',
        description: "Standard patrol officer's kit, including a duty pistol, reinforced vest, and non-lethal options.",
        items: [
            'Agency Badge and Identification Card',
    ...
    {
        name: 'BODYGUARD',
        description: 'Discreet protective detail equipment, focusing on a concealed pistol, reinforced vest, and secure communications.',
        items: [
            'Medium Pistol',
            'Sound Suppressor',
            'Reinforced Kevlar Vest',
    ...
    },
    {
        ...
        description: "A comprehensive set of tools for private investigators or detectives, including surveillance gear, lockpicks, and forged documents.",
        items: [
            'Small Evidence-Collection Kit',
    ...
    },
    {
        ...
        description: 'Equipment for field science and medical response, including a first responder kit, HAZMAT gear, and sample collection tools.',
        items: [
    ...
    },
    {
        ...
        description: 'Gear for clandestine operations, focusing on covert surveillance, secure communications, and false identification.',
        items: [
            'Encrypted Laptop',
            'Tablet Computer or Smartphone',
            'Burner Phone',
    ...
    {
        name: "SOLDIER'S KIT",
        description: 'Standard infantry loadout for a soldier or marine, including a rifle, body armor, and essential field survival gear.',
        items: [
            'Light Rifle or Carbine',
            'Medium Pistol',
            'Large Knife or Combat Dagger',
    ...
    },
    {
        ...
        description: 'Equipment for firefighters or paramedics, including breaching tools, a comprehensive medical kit, and protective gear.',
        items: [
            'Halligan Forcible-Entry Tool',
            'Wood Axe',
    ...
    {
        name: "CRIMINAL'S KIT",
        description: 'Basic tools for illegal activities, including a light pistol, lockpicks, and disposable burner phones.',
        items: [
            'Light Pistol',
            'Knife',
    ...
    {
        name: "CORPORATE KIT",
        description: 'Gear for a business executive operating in a corporate environment, including secure electronics and untraceable funds.',
        items: [
            'Encrypted Laptop',
            'Tablet Computer or Smartphone',
            'Burner Phone',
    ...
    {
        name: "EOD KIT",
        description: 'Specialized equipment for Explosive Ordnance Disposal technicians, including a bomb suit, diagnostic tools, and remote disruption gear.',
        items: [
            'Medium Pistol',
            'Light Rifle or Carbine',
            'Tactical Body Armor',
...
const SPECIALIZED_KITS: EquipmentKit[] = [
    {
        ...
        description: 'An enhanced Special Operator kit with access to classified intelligence reporting.',
        items: [
    ...
    },
    {
        ...
        description: 'An enhanced Intelligence/Covert Ops kit with access to classified intelligence reporting.',
        items: [
    ...
    },
    {
        ...
        description: 'A Federal Agent kit supplemented with specialized environmental testing and hazardous material handling equipment.',
        items: [
