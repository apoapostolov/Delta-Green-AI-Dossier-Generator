...
export const ExpressivePortraitsStudio: React.FC<ExpressivePortraitsStudioProps> = ({
    ...
    return (
        <div className="mt-8 pt-6 border-t-2 border-gray-700/50">
            <h2 className="text-2xl font-bold text-green-400 text-center mb-2">Expressive Portraits</h2>
            <p className="text-gray-400 text-center mb-6">
                Click on an emotion to generate a version of your agent expressing it. Use the selector to choose one for your PDF sheet.
            </p>
                            ...
                            {imageSrc && (
                                <div className="absolute inset-0">
                                    <PortraitDisplay
                                        ...
                                        // FIX: Renamed prop 'onSelectPdfPortrait' to 'onSelectForPdf' to match PortraitDisplay's props.
