    ...
    return (
        <div className="flex items-start gap-4">
            ...
            <button 
                ...
                className="w-12 h-12 p-3 rounded-lg bg-green-600 hover:bg-green-500 disabled:bg-gray-600 text-gray-900 transition-colors flex-shrink-0 flex items-center justify-center"
