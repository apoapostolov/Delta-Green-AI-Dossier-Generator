...
export const useCharacter = (setToastMessage: (msg: string | null, type?: ToastType) => void, aggregatedData: AggregatedData) => {
    ...
    const ignoreConsequences = useCallback(() => setCareerApplied(false), []);
    const adaptedToViolence = damagedVeteranOption === 'Extreme Violence';
    const adaptedToHelplessness = damagedVeteranOption === 'Captivity or Imprisonment';
